...
from acmeapp.app import create_app
from acmeapp.database import db
from acmeapp.settings import DevConfig, ProdConfig
from acmeapp.user.models import User

CONFIG = ProdConfig if os.environ.get('ACMEAPP_ENV') == 'prod' else DevConfig
